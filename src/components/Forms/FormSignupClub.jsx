    ...
    return (
      <div className="FormSignup">
        <form onChange={this.handleChange} onSubmit={this.handleSubmit}>
          ...
          <div className="field">
            <label className="label">Vidéo de présentation du club</label>
            <div className="control">
              <input
                className="input"
                type="text"
          ...
          <div className="field">
            ...
            <div className="control">
              <input
                ...
                type="text"
                name="subscriptionFee"
                placeholder="Précisez les différentes modalités d'inscription"
                defaultValue="100 ou 150€ annuel, 15€ mensuel"
              />
            </div>
          </div>
          ...
          <div className="field">
            ...
            <div className="control">
              <textarea
                className="textarea"
                name="description"
                placeholder="Objectifs, ambitions, besoins, politique de recrutement... tout ce que vous jugez utile de connaître pour un nouvel adhérent !"
                value="Faire la fête après les matchs !"
              ></textarea>
            </div>
          </div>
...
>>>>>>> update placeholders on signup club
}
